...
class BG extends Component {
  ...
  componentDidMount() {
    ...
    // Variables
    let randomColors = colors[randomIntFromRange(0,99)];
    ...
    addEventListener("mousedown", () => {
      randomColors = colors[randomIntFromRange(0,99)];
    ...
    function init() {
      ...
      for (let i = 0; i < 800; i++) {
        ...
        particles.push(new Particle(canvas.width + 400, canvas.height + 400, distance, distance, radius, randomColor(colors[66])));
      }
    }
  ...
  render(){
    return<canvas className="BG" ref={(e) => { this.canvas = e; }} />
  }
};
